      ...
      <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
        <div className="pointer-events-auto w-full max-w-sm rounded-2xl border border-white/10 bg-surface shadow-2xl animate-scale-up p-6 space-y-5 max-h-[90vh] overflow-y-auto">
          ...
          <div className="border-t border-white/10 pt-4 space-y-1">
            ...
            <a href="https://github.com/cordfuse/mighty-ai-qr-web" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs text-primary hover:underline">
              ...
              github.com/cordfuse/mighty-ai-qr-web
            </a>
          </div>
